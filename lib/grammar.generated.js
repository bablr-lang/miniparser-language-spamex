...
}, (_dec = CoveredBy('Expression'), _dec2 = CoveredBy('Matcher'), _dec3 = CoveredBy('Expression'), _dec4 = CoveredBy('Attribute'), _dec5 = CoveredBy('Attribute'), _dec6 = CoveredBy('Matcher'), _dec7 = CoveredBy('Expression'), _dec8 = CoveredBy('StringMatcher'), _dec9 = CoveredBy('Matcher'), _dec10 = CoveredBy('Expression'), _dec11 = CoveredBy('StringMatcher'), _dec12 = CoveredBy('Matcher'), _dec13 = CoveredBy('Expression'), _dec14 = InjectFrom(productions), _dec15 = InjectFrom(productions), _dec16 = InjectFrom(productions), class SpamexGrammar {
  static {
    [_initProto] = _applyDecs(this, [[_dec, 2, "Matcher"], [[_dec2, _dec3, Node], 2, "NodeMatcher"], [[_dec4, Node], 2, "BooleanAttribute"], [[_dec5, Node], 2, "StringAttribute"], [[_dec6, _dec7], 2, "StringMatcher"], [[_dec8, _dec9, _dec10, Node], 2, "String"], [[_dec11, _dec12, _dec13, Node], 2, "Regex"], [_dec14, 2, "List"], [_dec15, 2, "Match"], [[Node, _dec16], 2, "Punctuator"]], []).e;
  }
  constructor(...args) {
    _initProto(this);
  }
  ...
  *NodeMatcher() {
    ...
    if (yield _t.node(_l.Instruction, "Call", [_t.ref`verb`, _t.ref`arguments`], {
      ...
      yield _t.node(_l.Instruction, "Call", [_t.ref`verb`, _t.ref`arguments`], {
        ...
        arguments: _t.node(_l.Instruction, "Tuple", [_t.ref`open`, _t.ref`values[]`, _t.embedded(_t.s_t_node(_l.Space, "Space", [_t.lit(" ")], {}, {})), _t.ref`values[]`, _t.ref`close`], {
          open: _t.s_node(_l.Instruction, "Punctuator", "("),
          values: [_t.node(_l.Spamex, "NodeMatcher", [_t.ref`open`, _t.ref`flags`, _t.ref`language`, _t.ref`namespaceOperator`, _t.ref`type`, _t.ref`close`], {
            open: _t.s_node(_l.Spamex, "Punctuator", "<"),
            flags: _t.node(_l.CSTML, "Flags", [_t.ref`token`], {
              token: _t.s_node(_l.CSTML, "Punctuator", "*")
            }, {}),
